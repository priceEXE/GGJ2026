...
{
    /// <summary>
    /// 引用池，参考自Game Framework。
    /// </summary>
    public static partial class MFRefPool
    {
        ...
        public static void Release(IReference reference)
        {
            if (reference == null)
            {
                throw new MFException("Reference is invalid.");
            }
        ...
        private static void InternalCheckReferenceType(Type referenceType)
        {
            ...
            {
                throw new MFException("Reference type is invalid.");
            }

            if (!referenceType.IsClass || referenceType.IsAbstract)
            {
                throw new MFException("Reference type is not a non-abstract class type.");
            }

            if (!typeof(IReference).IsAssignableFrom(referenceType))
            {
                throw new MFException(MFUtils.Text.Format("Reference type '{0}' is invalid.",
        ...
        private static ReferenceCollection GetReferenceCollection(Type referenceType)
        {
            if (referenceType == null)
            {
                throw new MFException("ReferenceType is invalid.");
            }
